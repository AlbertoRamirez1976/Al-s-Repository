...
int sumList( ListNodePtr a )
{
ListNodePtr currentPtr; /* temporary pointer to list a */
int total = 0; /* sum of node values */

currentPtr = a; /* set currentPtr to list a */
...
{
ListNodePtr currentPtr; /* temporary pointer to list a */
double total = 0.0; /* sum of node values */
